...
describe("computeDurations — LLM time", () => {
  ...
  it("measures a single llm_call → llm_response pair", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 100), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
  ...
  it("sums multiple llm call durations across a tool loop", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 0), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
      ...
      { type: "llm_call", ts: ms(BASE, 900), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
...
describe("computeDurations — tool time", () => {
  it("measures a single tool batch (one tool)", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 950), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
  ...
  it("measures a parallel batch: span = max(result.ts) − min(call.ts)", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 850), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
  ...
  it("sums tool spans across multiple batches", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 420), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
      ...
      { type: "llm_call", ts: ms(BASE, 920), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
...
describe("computeDurations — turn time", () => {
  it("measures turn_end.ts − user_message.ts", () => {
    const events: WsEvent[] = [
      { type: "user_message", ts: ms(BASE, 0), content: "hi" },
      { type: "llm_call", ts: ms(BASE, 50), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
...
describe("computeLiveDurations — tool time", () => {
  ...
  it("does not double-count a batch after it has been flushed", () => {
    const events: WsEvent[] = [
      ...
      { type: "llm_call", ts: ms(BASE, 450), url: "", model: "m", contextHashes: [], cacheBreakpointIndex: null },
