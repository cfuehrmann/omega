export const config = {
  ...
  systemPrompt: [
    ...
    "",
    "## Git discipline (REC-0)",
    "",
    "Before any self-modifying session, a `pre-edit-<timestamp>` tag should exist",
    "at HEAD (created by the operator). If one doesn't exist and you are about to",
    "edit src/, remind the operator.",
    "`just gate` is the operator-run test gate — never invoke it automatically.",
    "`stable` branch = last operator-certified green anchor.",
    "If tests go red: stop, read plan/future.md, revert to stable or the pre-edit",
    "tag before re-attempting. Never commit or push red code.",
    "",
    "## Testing discipline",
    "",
