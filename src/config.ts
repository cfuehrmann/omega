export const config = {
  ...
  systemPrompt: [
    ...
    "Record open design questions in plan/future.md before writing any code.",
    "",
    "## Git discipline (REC-0)",
    "",
    "Two branches: `main` = stable (operator merges develop→main when satisfied).",
    "`develop` = working branch. Omega commits to develop only.",
